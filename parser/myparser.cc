...
#line 37 "myparser.cc" // lalr1.cc:404
...
#line 51 "myparser.cc" // lalr1.cc:412
// Unqualified %code blocks.
#line 19 "myparser.yy" // lalr1.cc:413

#include "mydriver.hpp"

#line 57 "myparser.cc" // lalr1.cc:413
...
namespace yy {
#line 143 "myparser.cc" // lalr1.cc:479
...
#line 37 "myparser.yy" // lalr1.cc:636
        {yyoutput << yysym.value.template as< std::string > ();}
#line 328 "myparser.cc" // lalr1.cc:636
        break;
...
#line 335 "myparser.cc" // lalr1.cc:636
        break;
...
#line 37 "myparser.yy" // lalr1.cc:636
        {yyoutput << yysym.value.template as< int > ();}
#line 342 "myparser.cc" // lalr1.cc:636
        break;
  ...
  myparser::parse ()
  {
    ...
    #line 14 "myparser.yy" // lalr1.cc:741
{
yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 460 "myparser.cc" // lalr1.cc:741
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 40 "myparser.yy" // lalr1.cc:859
    {driver.result = yystack_[0].value.as< int > (); }
#line 579 "myparser.cc" // lalr1.cc:859
    break;

  case 3:
#line 42 "myparser.yy" // lalr1.cc:859
    {}
#line 585 "myparser.cc" // lalr1.cc:859
    break;

  case 4:
#line 43 "myparser.yy" // lalr1.cc:859
    {}
#line 591 "myparser.cc" // lalr1.cc:859
    break;

  case 5:
#line 45 "myparser.yy" // lalr1.cc:859
    {driver.variables[yystack_[2].value.as< std::string > ()] = yystack_[0].value.as< int > ();}
#line 597 "myparser.cc" // lalr1.cc:859
    break;

  case 6:
#line 49 "myparser.yy" // lalr1.cc:859
    {yylhs.value.as< int > () = yystack_[2].value.as< int > () + yystack_[0].value.as< int > ();}
#line 603 "myparser.cc" // lalr1.cc:859
    break;

  case 7:
#line 50 "myparser.yy" // lalr1.cc:859
    {yylhs.value.as< int > () = yystack_[2].value.as< int > () - yystack_[0].value.as< int > ();}
#line 609 "myparser.cc" // lalr1.cc:859
    break;

  case 8:
#line 51 "myparser.yy" // lalr1.cc:859
    {yylhs.value.as< int > () = yystack_[2].value.as< int > () * yystack_[0].value.as< int > ();}
#line 615 "myparser.cc" // lalr1.cc:859
    break;

  case 9:
#line 52 "myparser.yy" // lalr1.cc:859
    {yylhs.value.as< int > () = yystack_[2].value.as< int > () / yystack_[0].value.as< int > ();}
#line 621 "myparser.cc" // lalr1.cc:859
    break;

  case 10:
#line 53 "myparser.yy" // lalr1.cc:859
    {std::swap(yylhs.value.as< int > (),yystack_[1].value.as< int > ());}
#line 627 "myparser.cc" // lalr1.cc:859
    break;

  case 11:
#line 54 "myparser.yy" // lalr1.cc:859
    {yylhs.value.as< int > () = driver.variables[yystack_[0].value.as< std::string > ()];}
#line 633 "myparser.cc" // lalr1.cc:859
    break;

  case 12:
#line 55 "myparser.yy" // lalr1.cc:859
    {std::swap(yylhs.value.as< int > (),yystack_[0].value.as< int > ());}
#line 639 "myparser.cc" // lalr1.cc:859
    break;


#line 643 "myparser.cc" // lalr1.cc:859
            default:
              break;
            }
        }
...
#undef YYCASE_
  ...
  myparser::yypact_[] =
  {
      -5,     5,     4,    -5,     6,    10,    -5,    -5,    15,    -5,
      -3,     6,     6,     6,     6,     6,    -5,    15,    17,    17,
      -5,    -5
  };
  ...
  myparser::yystos_[] =
  {
       0,    14,    15,     0,     8,    11,    12,    16,    17,    11,
      17,     3,     4,     5,     6,     7,     9,    17,    17,    17,
      17,    17
  };
...
#line 1020 "myparser.cc" // lalr1.cc:1167
#line 56 "myparser.yy" // lalr1.cc:1168
