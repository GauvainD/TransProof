...
#line 8 "myparser.yy" // lalr1.cc:377

#include <string>
class mydriver;

#line 49 "myparser.hh" // lalr1.cc:377
...
namespace yy {
#line 126 "myparser.hh" // lalr1.cc:377
  ...
  template <typename Base>
  myparser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const int v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  template <typename Base>
  myparser::basic_symbol<Base>::basic_symbol (typename Base::kind_type t, const std::string v, const location_type& l)
    : Base (t)
    , value (v)
    , location (l)
  {}
  ...
  myparser::symbol_type
  myparser::make_LPAREN (const location_type& l)
  {
    return symbol_type (token::TOK_LPAREN, l);
  }

  myparser::symbol_type
  myparser::make_RPAREN (const location_type& l)
  {
  ...
  myparser::symbol_type
  myparser::make_IDENTIFIER (const std::string& v, const location_type& l)
  {
    return symbol_type (token::TOK_IDENTIFIER, v, l);
  }

  myparser::symbol_type
  myparser::make_NUMBER (const int& v, const location_type& l)
  {
...
#line 1033 "myparser.hh" // lalr1.cc:377
